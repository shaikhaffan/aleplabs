...
// Styles
import styles from './Styles/NearbyScreenStyle'
    ...
    tabBarIcon: ({ focused, tintColor }) => {
      return (
        <View style={{ justifyContent: "center", alignItems: "center" }}>
            <Icon name='room' size={scale(25)} color={(focused) ? Colors.storePurpuleColor: Colors.storeTextColor} />
          <Text style={{ fontSize: scale(10) }}>Nearby</Text>
        </View>
      );
    },
